...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2018 at 12:39 PM
...
INSERT INTO `tbl_job_seeker` (`id`, `name`, `gender`, `date_of_birth`, `address`, `educational_qualification`, `experience_year`, `experience_details`, `general_category_id`, `skill_level_id`, `professional_category_id`, `district_id`, `upazila_id`, `contact_no`, `email`, `category_type`, `file_name`, `status`, `created_at`) VALUES
(10, 'Hasan', 'পুরুষ', '35', 'Barisal', '', '', '', 0, 0, 9, 35, 13, '0172312345', '', 'Professional', '', 'Verified', '2018-03-05 00:32:59'),
...
--
ALTER TABLE `tbl_upazila`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'PK', AUTO_INCREMENT=493;
