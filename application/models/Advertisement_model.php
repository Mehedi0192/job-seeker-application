...
class Advertisement_model extends CI_Model {
	...
	var $column_order = array(null, 'company_name', 'website', 'ads_position');
	var $column_search = array('company_name', 'website', 'ads_position');
	...
	public function ads_by_position($ads_position, $limit=NULL) {
		$this->db->select('*');
		$this->db->from($this->table);
		$this->db->where('ads_position', $ads_position);
		if($limit!=NULL) {
			$this->db->limit($limit);
		}
