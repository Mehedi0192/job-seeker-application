...
<script>
	$(document).ready(function () {
		...
		$('#msg').fadeOut(5000);<!-- this is for message hide -->
	});
</script>

	<script type="text/javascript"		>
	function altVerified() 			{
		return confirm('Are you sure you want to verified?')	;
	}
	function altEdit() 			{
		return confirm('Are you sure you want to edit this data?')	;
	}
	function altDelete() 			{
		return confirm('Are you sure you want to delete this data permanently?');
	}
	function altRemoveImg() 			{
		return confirm('Are you sure you want to remove this image permanently?');
	}
