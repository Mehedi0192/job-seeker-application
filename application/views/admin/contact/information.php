			...
			<div class="widget-body">
				<div class="widget-main">
					<form id="myForm" action="<?php echo base_url() . 'contact/save/' . md5($edit->id); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">   
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"> Phone No </label>
							<div class="col-sm-9">
								<input type="text" name="phone_no" value="<?php echo $edit->phone_no; ?>" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<span class="error"> Logo Size 308 x 57 </span>
								<br />
