...
class Bn extends CI_Controller {
	...
	public function seekers() {
		...
		// Pagination settings
		$config['base_url'] = base_url() . 'bn/seekers';
	...
	public function general($category = NULL, $skill=NULL) {
		...
		// Pagination settings
		$config['base_url'] = base_url() . 'bn/general/'.$category.'/'.$skill;
		$config['per_page'] = $this->perPage;
	...
	public function professional($category = NULL) {
		...
		// Pagination settings
		$config['base_url'] = base_url() . 'bn/professional/'.$category;
		$config['per_page'] = $this->perPage;
	...
	public function searching($district=NULL, $upazila=0) {
		...
		// Pagination settings
		$config['base_url'] = base_url() . 'bn/searching/'.$district.'/'.$upazila;
		$config['per_page'] = $this->perPage;
		$config["uri_segment"] = 5;
	...
	public function search_by_key($searchKey=NULL) {
		...
		// Pagination settings
		$config['base_url'] = base_url() . 'bn/search_by_key/'.$searchKey;
		$config['per_page'] = $this->perPage;
		$config["uri_segment"] = 4;
